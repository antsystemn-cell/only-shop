...
import {
  ...
  Package, Truck, DollarSign, MessageSquare, Calendar, Filter, X,
} from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Бүх захиалгуудыг харах, удирдах</p>
        </div>
        <Tabs value={viewMode} onValueChange={(v) => setViewMode(v as any)}>
          <TabsList>
            <TabsTrigger value="orders">Захиалгаар</TabsTrigger>
            <TabsTrigger value="items">Барааагаар</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <Input type="date" value={dateFrom} onChange={(e) => setDateFrom(e.target.value)} placeholder="Эхлэх огноо" />
            <div className="flex gap-2">
              <Input type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} placeholder="Дуусах огноо" className="flex-1" />
              {hasFilters && (
