      ...
      <form onSubmit={handleSubmit}>
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="apartment" value={addressForm.apartment} onChange={(e) => setAddressForm({ ...addressForm, apartment: e.target.value })} placeholder="1-р орц, 305 тоот" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="phone">Утас *</Label>
                    <Input id="phone" value={addressForm.phone} onChange={(e) => setAddressForm({ ...addressForm, phone: e.target.value })} placeholder="99001122" />
            ...
            <Card>
              <CardHeader><CardTitle>Нэмэлт тэмдэглэл</CardTitle></CardHeader>
              <CardContent>
                <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Захиалгын талаар нэмэлт мэдээлэл..." rows={3} />
              </CardContent>
            </Card>
          </div>
